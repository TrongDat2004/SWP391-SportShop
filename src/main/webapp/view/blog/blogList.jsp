                        ...
                        <c:choose>
                                    ...
                                    <c:forEach var="blog" items="${blogs}">
                                        <div class="blog-card">
                                            ...
                                            <div class="blog-content">
                                                ...
                                                <a href="blogs?action=detail&id=${blog.blogId}" class="read-more">Read More</a>
                                            </div>
                                        </div>
                                    </c:forEach>
                                </div>
                            ...
                            <c:otherwise>
                                <div class="no-results">
                                    ...
                                    <p>Sorry, we couldn’t find any articles that match your search. Please try again with a different keyword.</p>
                                    <a href="blogs" class="read-more">View all articles</a>
                                </div>
                            </c:otherwise>
                        </c:choose>
                            ...
                            <nav>
                                <ul class="pagination">
                                    <c:if test="${currentPage > 1}">
                                        <li class="page-item">
                                            <a class="page-link" href="blogs?page=${currentPage - 1}&search=${search}" aria-label="Previous">
                                    ...
                                    <c:forEach var="i" begin="1" end="${totalPages}">
                                        <li class="page-item ${i == currentPage ? 'active' : ''}">
                                            <a class="page-link" href="blogs?page=${i}&search=${search}">${i}</a>
                                        </li>
                                    </c:forEach>

                                    <c:if test="${currentPage < totalPages}">
                                        <li class="page-item">
                                            <a class="page-link" href="blogs?page=${currentPage + 1}&search=${search}" aria-label="Next">
