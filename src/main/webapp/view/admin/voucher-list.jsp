...
<html lang="en">
    <head>
        ...
        <title>Voucher Management || Clothing</title>
        ...
        <c:url value="/admin/manage-voucher" var="paginationUrl">
        ...
        <div class="dashboard-main-body">
            <div class="d-flex flex-wrap align-items-center justify-content-between gap-3 mb-24">
                <h6 class="fw-semibold mb-0">Voucher Management</h6>
                <ul class="d-flex align-items-center gap-2">
                    ...
                    <li>-</li>
                    <li class="fw-medium">Voucher List</li>
                </ul>
            </div>
            ...
            <div class="card mb-24">
                <div class="card-body p-24">
                    <form action="${pageContext.request.contextPath}/admin/manage-voucher" method="GET">
                        <div class="row g-3">
                            <div class="col-md-3">
                                <input type="text" class="form-control" name="search" placeholder="Search by voucher code" value="${param.search}">
                            </div>
                            <div class="col-md-2">
                            ...
                            <div class="col-md-2">
                                <a href="${pageContext.request.contextPath}/admin/manage-voucher?action=add" class="btn btn-success w-100">
                                    Add New Voucher
                                </a>
                            </div>
                        </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex gap-2">
                                                <a href="${pageContext.request.contextPath}/admin/manage-voucher?action=edit&id=${voucher.voucherId}" 
        ...
        <script>
            function confirmDelete(voucherId) {
                if (confirm('Are you sure you want to delete this voucher?')) {
                    window.location.href = '${pageContext.request.contextPath}/admin/manage-voucher?action=delete&id=' + voucherId;
                }
            }
        </script>
    </body>
