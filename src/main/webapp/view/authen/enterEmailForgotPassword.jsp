<%@page contentType="text/html" pageEncoding="UTF-8" %>
    ...
    <head>
        ...
        <title>SportShop | Forgot Password</title>
        ...
        <main style="padding-top: 140px;">
            ...
            <section class="inner-hero-section px-xl-20 px-lg-10 px-sm-7"
                ...
                <div class="container-fluid">
                    <span class="text-animation-word text-h1 text-n100 mb-3">Forgot Password</span>
                            ...
                            <div class="register-form p-xl-15 p-lg-10 p-md-8 p-6 radius-16 border border-n100-1 bg-n20">
                                ...
                                <form action="${pageContext.request.contextPath}/authen?action=forgot-password" method="POST"
                                    ...
                                    <div class="d-grid gap-lg-4 gap-2">
                                        <label class="text-n100 font-noto-sans text-base fw-normal">Enter Your
                                            Email</label>
                                    ...
                                    <button type="submit"
                                        class="btn-secondary py-lg-4 py-2 px-lg-6 px-4 radius-8 w-100">Send OTP</button>
                                </form>
