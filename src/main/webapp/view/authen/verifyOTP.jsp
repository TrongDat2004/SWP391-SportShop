...
<html lang="en">
    ...
    <head>
        ...
        <title>ShopSport | Verify OTP</title>
            ...
            <main class="pt-12">
                ...
                <section class="inner-hero-section px-xl-20 px-lg-10 px-sm-7"
                    ...
                    <div class="container-fluid">
                        <span class="text-animation-word text-h1 text-n100 mb-3">Verify OTP</span>
                            ...
                            <div class="col-xl-5 col-lg-7 col-md-9">
                                <div class="register-form p-xl-15 p-lg-10 p-md-8 p-6 radius-16 border border-n100-1 bg-n20">
                                    <div class="register-logo mb-lg-15 mb-md-10 mb-8 mx-auto">
                                        <img class="w-100" src="${pageContext.request.contextPath}/assets/images/logo.jpg"
                                         alt="logo">
                                </div>
                                <form action="${pageContext.request.contextPath}/authen?action=verify-otp" method="POST"
                                    ...
                                    <div class="d-grid gap-lg-4 gap-2">
                                        <label class="text-n100 font-noto-sans text-base fw-normal">Enter OTP</label>
                                        <input type="text" name="otp"
                                               class="py-lg-4 py-2 px-lg-6 px-4 w-100 bg-n0 text-n100 radius-8 border border-n100-1 focus-secondary2"
                                               placeholder="Enter OTP" required>
                                    </div>
                                    <button type="submit"
                                            class="btn-secondary py-lg-4 py-2 px-lg-6 px-4 radius-8 w-100">Verify
                                        OTP</button>
                                </form>

                                <div class="text-center">
                                    <span class="text-n50">Didn't receive OTP?</span>
                                    <a href="${pageContext.request.contextPath}/authen?action=resend-otp"
                                       class="text-secondary2 fw-medium">Resend OTP</a>
                                </div>
                            </div>
                        </div>
                    </div>
