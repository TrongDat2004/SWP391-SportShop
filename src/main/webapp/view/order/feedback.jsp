            ...
            <main class="pt-12">
                <section class="product-section px-xl-20 px-lg-10 px-sm-7 pt-120 pb-120">
                    <div class="container mt-5">
                        <h2 class="text-center mb-4">Write Feedback</h2>
                        ...
                        <div class="card p-4 shadow">
                            ...
                            <form action="feedback" method="post">
                                    ...
                                    <div class="d-flex">
                                        <c:forEach begin="1" end="5" var="i">
                                            <input type="radio" class="btn-check" name="rating" id="star${i}" value="${i}" 
                                                   <c:if test="${feedback != null && feedback.rating == i}">checked</c:if> required>
                                            <label class="btn btn-outline-warning" for="star${i}"><i class="fas fa-star"></i> ${i}</label>
                                        </c:forEach>
                                    </div>
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control" id="content" name="content" rows="4" placeholder="Write your feedback here..." required>${feedback.content}</textarea>
                                </div>

                                <button type="submit" class="btn btn-dark">
                                    <i class="fas fa-paper-plane"></i> Submit Feedback
                                </button>
                                <a href="order-details?orderid=${order.orderId}" class="btn btn-dark-1"><i class="fas fa-arrow-left"></i> Back</a>
                            </form>
                        </div>
                    </c:if>
                    ...
                    <c:if test="${order.status != 'completed'}">
                        <div class="alert alert-warning">
                            <i class="fas fa-exclamation-triangle"></i> You can only leave feedback for completed orders.
                        </div>
                    </c:if>
                </div>
            </section>
